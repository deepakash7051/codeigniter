<div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
    ...
    <div class="bottom-border pb-3">
        <img src="assets/images/img-1.jpg" width="50" class="rounded-circle mr-3">
        <a href="#" class="text-white">Gautam</a>
    </div>
    <ul class="navbar-nav flex-column mt-4">
        ...
        <li class="nav-item"><a href="<?='ques-type'?>" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-user text-light fa-lg mr-3"></i>Question Type</a></li>
